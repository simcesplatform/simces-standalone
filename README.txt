...
Copyright (c) 2022-2023 Tampere University and VTT Technical Research Centre of
...
!!!
Make sure there are no spaces in the directory path! Spaces will prevent some commands from working.
!!!
...
To start the example simulation (Energy Community):  
