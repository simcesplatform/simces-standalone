...
module.exports = {
  mongodb: {
    ...
    ssl: process.env.ME_CONFIG_MONGODB_SSL ? process.env.ME_CONFIG_MONGODB_SSL === 'true' : false,

    // sslValidate: validate mongod server certificate against CA
    sslValidate: process.env.ME_CONFIG_MONGODB_SSLVALIDATE ? process.env.ME_CONFIG_MONGODB_SSLVALIDATE === 'true' : false,
